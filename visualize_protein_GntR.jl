...
function plot_prot_GntR_data(time_array, simulation_data_array, experimental_data_dictionary)
    ...
    # wwrite -
    PyPlot.savefig("./plots/Prot-GntR-Ensemble.pdf")
end
...
function main(path_to_simulation_dir::String, path_to_plot_file::String)
    ...
    # plot -
    plot_prot_GntR_data(time_array, data_array, exp_dd)
end
