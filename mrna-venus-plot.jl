...
function main(path_to_simulation_dir::String, path_to_plot_file::String)
    ...
    LB = μ .- (2.576/sqrt(1))*σ #99 percentage interval
    UB = μ .+ (2.576/sqrt(1))*σ #99 percentage interval
	...
	DATA = experimental_data_dictionary["mRNA_data_array"][[1,2,4,5],2]
	STD = (1/sqrt(3))*experimental_data_dictionary["mRNA_data_array"][[1,2,4,5],3]
