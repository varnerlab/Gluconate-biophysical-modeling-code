...
function plot_mRNA_GntR_data(time_array, simulation_data_array, experimental_data_dictionary)
    ...
    DATA = experimental_data_dictionary["mRNA_data_array"][:,4]
    STD = (1.96/sqrt(3))*experimental_data_dictionary["mRNA_data_array"][:,5]
...
function main(path_to_simulation_dir::String, path_to_plot_file::String)
    ...
    # plot -
    plot_mRNA_GntR_data(time_array, data_array, exp_dd)
end
